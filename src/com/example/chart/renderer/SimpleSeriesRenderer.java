...
/**
 * A simple series renderer. 一个简单的渲染器系列。
 */
public class SimpleSeriesRenderer implements Serializable {
   ...
   */
	 ...
	 * 是否显示为一个高亮片段区域(饼图显示片分解视图)。
	 */
	private boolean				mHighlighted;

	/**
	 * Returns the series color. 返回系列的颜色。
	 * 
	...
	/**
	 * Returns if the chart point values should be displayed as text. 返回
	 * 图点的值是否需要显示为文本。
	 * 
	...
	/**
	 * Sets if the chart point values should be displayed as text. 设置
	 * 图点的值是否需要显示为文本。
	 * 
	 * @param display
	...
	/**
	 * Returns the chart values minimum distance. 返回值最小距离的图表。
	 * 
	...
	/**
	 * Sets chart values minimum distance. 设置 值最小距离的图表。
	 * 
	 * @param distance
	...
	/**
	 * Returns the chart values text size. 返回 图表文字大小值。
	 * 
	...
	/**
	 * Sets the chart values text size. 设置 图表文字大小值。
	 * 
	 * @param textSize
	...
	/**
	 * Returns the chart values text align. 返回 表值文本对齐方式。
	 * 
	...
	/**
	 * Sets the chart values text align. 设置 表值文本对齐方式。
	 * 
	 * @param align
	...
	/**
	 * Returns the chart values spacing from the data point. 返回 图表数据点的间距值。
	 * 
	...
	/**
	 * Sets the chart values spacing from the data point. 设置 图表数据点的间距。
	 * 
	 * @param spacing
	...
	/**
	 * Returns the stroke style. 返回 描边风格
	 * 
	...
	/**
	 * Returns the gradient is enabled value. 返回 是否启用了梯度。
	 * 
	...
	/**
	 * Sets the gradient enabled value. 设置 是否启用梯度
	 * 
	 * @param enabled
	...
	/**
	 * Returns the gradient start value. 返回 梯度-开始值
	 * 
	...
	/**
	 * Returns the gradient start color. 设置 梯度-开始值
	 * 
	...
	/**
	 * Sets the gradient start value and color. 设置 梯度-开始值 和 渐变开始颜色
	 * 
	 * @param start
	...
	/**
	 * Returns the gradient stop value. 返回 梯度-结束值。
	 * 
	...
	/**
	 * Returns the gradient stop color. 返回 渐变结束颜色。
	 * 
	...
	/**
	 * Sets the gradient stop value and color. 设置 梯度-结束值 和 渐变结束颜色。
	 * 
	 * @param start
	...
	/**
	 * Returns if the legend item for this renderer should be visible. 返回
	 * 渲染器的图例条目是否可见。
	 * 
	...
	/**
	 * Sets if the legend item for this renderer should be visible. 设置
	 * 渲染器的图例条目是否可见。
	 * 
	 * @param showLegend
	...
	/**
	 * Returns if the item is displayed highlighted. 返回
	 * 是否显示为一个高亮片段区域(饼图显示片分解视图)。
	 * 
	...
	/**
	 * Sets if the item for this renderer should be highlighted. Pie chart is
	 * supported for now. 设置 是否显示为一个高亮片段区域，饼图的支持。
	 * 
	 * @param highlighted
	...
	/**
	 * Returns the number format for displaying chart values. 返回 数字格式显示表的值。
	 * 
	...
	/**
	 * Sets the number format for displaying chart values. 设置 数字格式显示表的值。
	 * 
	 * @param format
